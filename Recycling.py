...
levels= 10
start_speed= 10
non_recycle=['bag','battery','bottle','chips']
game_over= False
game_complete= False
current_level= 1
items=[]
...
def draw():
    ...
    if game_over:
        screen.draw.text("Game Over!",(150, HEIGHT/2), fontsize= 80, color= "green")
    elif game_complete:
        screen.draw.text("You finished the game!",(150, HEIGHT/2), fontsize= 50, color= "green")
    else:
        for i in items:
            i.draw()
def update():
